def run_example():
    ...
    is_affordable = check_affordability(loan_amount, property_value, 0.9) #Bład
    print_results(is_affordable)


def check_affordability(loan_amount, property_value, *, max_ltv=0.8): #Wymuszamy uzycia arugmentu nazwanego
